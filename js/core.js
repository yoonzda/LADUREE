$(document).ready(function(){
    ...
    cartTabMenu(".cartContainer>ol li",".cartContainer div input[type='button'].pink:not([value^='payer'])",".cartContainer>div:not(.pop,:last-of-type)",".cartContainer>div:last-of-type div:not(:first-of-type) strong",".cartContainer>div:last-of-type>div");
